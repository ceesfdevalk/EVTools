...
#' 
#' @usage Value <- FitGW(X, method= "FitGW_iHilli", p= NULL, N= 0, r11= 1, fixedpar= NULL, l0= NULL, sigma= Inf, metadata= NULL)
#' 
...
#' 
#' @export
FitGW <- function(X, method, p, N, r11, fixedpar, l0, sigma, metadata) {
  ...
  if (length(known)< 1) {
    stop("Specified method is unknown to FitGW.R")
  }
