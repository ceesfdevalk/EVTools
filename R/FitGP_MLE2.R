...
#' 
#' @usage Value <- FitGP_MLE2(X, p, N= 0, r11= 1, fixedpar= NULL, l0= NULL, sigma= Inf, metadata= NULL)
#' 
...
#' 
#' @export
FitGP_MLE2 <- function(X, p, N, r11, fixedpar, l0, sigma, metadata) {
  ...
  if (n > 0) {
    ...
    if (nl> 0) {
      ...
      estimates <- list("k"= k, "l"= l, "y"= y, 
                        ...
                        "orderstats"= X0, "df"= "GP", 
                        "method"= "FitGP_MLE2", "metadata"= metadata)
